...
#define DEACH_INT		(0x838)
#define DEACH_INTMASK		(0x83c)
#define DIEP0_INTMASK		(0x840)
#define DIEP1_INTMASK		(0x844)
#define DOEP0_INTMASK		(0x880)
#define DOEP1_INTMASK		(0x884)
*/
...
/* DAINT_MASK */
#define OUTEPMSK_BIT		BIT16
#define INEPMSK_BIT		BIT0

/* DOEP_MASK */
#define XFERCOMPIMSK_BIT	BIT0
#define SETUPMSK_BIT		BIT3
#define B2BSETUP_BIT		BIT6
...
/* JZ_UDC_OTG_GINTSTS/JZ_UDC_OTG_GINTMSK core interrupt register */
...
/* JZ_UDC_OTG_DCTL device control register */
#define NORMAL_OPERATION		(0x1<<0)
#define SOFT_DISCONNECT		(0x1<<1)

/* JZ_UDC_OTG_DAINT device all endpoint interrupt register */
#define DAINT_OUT_BIT			(16)
#define DAINT_OUT_MASK			(0xFFFF)

/* JZ_UDC_OTG_DIEPCTL0/DOEPCTL0 device
...
/* JZ_UDC_OTG_DIEPMSK/DOEPMSK device IN/OUT endpoint
   common interrupt mask register */
/* JZ_UDC_OTG_DIEPINTn/DOEPINTn device IN/OUT endpoint interrupt register */
