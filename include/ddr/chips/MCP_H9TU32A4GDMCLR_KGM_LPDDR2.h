...
#define DDR_CL  	3  /* CAS latency: , LPDDR no */
...
#define DDR_tWTR 	MAX(2, 10 * 1000)  /* WRITE to READ command delay. */
/*
 * LPDDR2 controller timing2 register
*/
#define DDR_tRFC 	130 /* ns,  AUTO-REFRESH command period. */
//#define DDR_tRFC 	130 /* ns,  AUTO-REFRESH command period. */
#define DDR_tMINSR 	30  /* Minimum Self-Refresh / Deep-Power-Down , tCK, no */
