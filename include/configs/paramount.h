...
#ifndef __CONFIG_PARAMOUNT_H__
#define __CONFIG_PARAMOUNT_H__
...
#ifdef CONFIG_BOOT_ANDROID
    #ifdef CONFIG_SPL_MMC_SUPPORT
        #define CONFIG_BOOTCOMMAND "batterydet; cls; boota mmc 0 0x80f00000 6144"
...
#define CONFIG_400MAH_PARAMOUNT_CAPACITY_BATTERY
#define CONFIG_BATTERY_VOLTAGE_MAX       4350
#define CONFIG_BATTERY_VOLTAGE_MIN       3350
#define CONFIG_BATTERY_VOLTAGE_SCALE     200
...
#define CONFIG_GPIO_RECOVERY_KEY          GPIO_PD(17)
