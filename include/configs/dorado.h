...
/*	#define CONFIG_BOOTARGS BOOTARGS_COMMON " ip=off root=/dev/ram0 rw rdinit=/linuxrc" */
  ...
  #else
	#define CONFIG_BOOTARGS BOOTARGS_COMMON " ubi.mtd=1 root=ubi0:ndsystem rootfstype=ubifs rw"
  #endif
#endif
...
/*    #define CONFIG_BOOTCOMMAND "tftpboot 0x80600000 bliu/85/uImage.new; bootm" */
  ...
  #else
	#define CONFIG_BOOTCOMMAND  "mtdparts default; ubi part root; ubifsmount ubi:ndboot;" \
...
#define MTDPARTS_DEFAULT                "mtdparts=nand:8m(boot),-(root)"
