...
#define CONFIG_BOOTX_BOOTARGS       BOOTARGS_COMMON "ip=off init=/linuxrc rootfstype=cramfs root=/dev/mtdblock3 rw"
#undef  CONFIG_BOOTCOMMAND
#define CONFIG_BOOTCOMMAND    "bootx sfc 0x80f00000 0x800000"
#endif
