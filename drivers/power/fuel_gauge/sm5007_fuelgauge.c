...
int sm5007_fg_bulk_writes_bank1(unsigned char addr, u8 reg, u8 len,
        uint8_t *val) {
    int ret = -1;
...
static int32_t sm5007_fg_i2c_write_word(unsigned char addr, unsigned char reg,
        uint16_t data) {
    int ret;
