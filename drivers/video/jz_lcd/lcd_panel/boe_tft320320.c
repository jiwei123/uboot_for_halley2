...
void panel_init_set_sequence(struct dsi_device *dsi)
{
	...
	struct dsi_cmd_packet boe_tft320320_cmd_list[] = {
		...
		{0x39, 0x02, 0x00, {0xC1, 0x47}},
		{0x39, 0x05, 0x00, {0xC5, 0x00, 0x33, 0x00, 0x40}},
		{0x39, 0x02, 0x00, {0xC2, 0x22}},
		{0x39, 0x10, 0x00, {0xE0, 0x00, 0x07, 0x0B, 0x02, 0x0E, 0x04, 0x0E, 0x9A, 0x74, 0x06, 0x0D, 0x15, 0x3D, 0x35, 0x0F}},
		{0x39, 0x10, 0x00, {0xE1, 0x00, 0x08, 0x10, 0x00, 0x14, 0x09, 0x08, 0x68, 0x7F, 0x06, 0x11, 0x0E, 0x34, 0x37, 0x0F}},
		{0x05, 0x11, 0x00},
	};
