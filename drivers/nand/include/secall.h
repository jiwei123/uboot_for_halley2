...
#define SC_AES_INITRAM 		0x1
#define SC_AES_DECCBC		0x3
#define SC_AES_INSTKBOX		0x7
#define SC_AES_INITKBOX		0xf

#define SC_AES_SETEMMK		0x1f
#define SC_AES_SETCTRL		0x3f
#define SC_AES_GETPKB		0x7f
#define SC_AES_DECECB		0xff
