...
//#define CONFIG_LCD_REGULATOR_9          "RICOH619_LDO4"
//#define CONFIG_LCD_REGULATOR_10         "RICOH619_LDO6"
...
void board_set_lcd_power_on(void)
{
    ...
    if (lcd_vci_2v8 == NULL)
        return;
#if 1//defined(CONFIG_IN901) || defined(CONFIG_X3)
...
#if (defined(CONFIG_ACRAB) || defined(CONFIG_AW808) || defined(CONFIG_SWIMBOT))
struct boe_hsx0154b24b_data boe_hsx0154b24b_pdata = {
	.gpio_lcd_rd  = GPIO_PC(14),
	.gpio_lcd_rst = GPIO_PC(19),
	.gpio_lcd_cs  = GPIO_PC(17),
