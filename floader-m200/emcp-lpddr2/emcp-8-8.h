...
#define DDR_tMINSR  MAX(3, 15 * 1000)  /* Tckesr Minimum Self-Refresh / Deep-Power-Down , ns, no */
...
#define DDR_tRL     MATCH(get_ddr_freq(), 0)/*4*/   /* LPDDR2: Read Latency  - 3 4 5 6 7 8 , tck*/
#define DDR_tWL     MATCH(get_ddr_freq(), 1)/*2*/   /* LPDDR2: Write Latency - 1 2 2 3 4 4 , tck*/
 ...
 */
#define DDR_tREFI    3900    /* Refresh period: 4096 refresh cycles/64ms , line / 64ms */
